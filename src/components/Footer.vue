  ...
  <footer>
    ...
    <section id="footer__bottom">
      <div class="container">
        ...
        <!-- copyright -->
        <div
          class="footer__bottom__lower d-flex text-secondary justify-content-between"
        >
          <ul>
            <li>Terms of Use</li>
